...
public class GalleriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView galleries = findViewById(R.id.gals);
        GalleriesListAdapter adapter = new GalleriesListAdapter(titles,images,getApplicationContext());
    ...
    public void addGallery(View view){
        Intent intent = new Intent(getApplicationContext(),NewGalleryActivity.class);
    ...
    public void showPaintings(){
        Intent intent = new Intent(getApplicationContext(),PaintingsActivity.class);
        startActivity(intent);
    }
    ...
    public  class GalleriesListAdapter extends BaseAdapter {
        ...
        public GalleriesListAdapter(ArrayList<String> titles,ArrayList<Integer> images,Context context){
            this.titles = titles;
            this.images = images;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            view = inflter.inflate(R.layout.galleries_row, null);
